...
export class MilkProductionController {
  ...
  @ApiOperation({ summary: 'Create a new milk production record' })
  @Post()
  ...
  @ApiOperation({ summary: 'Get all milk production records' })
  @Get()
  findAll() {
    return this.milkProductionService.findAll();
  }

  @ApiOperation({ summary: 'Get a specific milk production record by ID' })
  @Get(':id')
  findOne(@Param('id') id: string) {
    return this.milkProductionService.findOne(+id);
  }

  @ApiOperation({ summary: 'Update a milk production record by ID' })
  @Patch(':id')
  update(
    @Param('id') id: string,
  ...
  @ApiOperation({ summary: 'Remove a milk production record by ID' })
  @Delete(':id')
